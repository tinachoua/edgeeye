const routes = [
  {
    ...
    children: [
      ...
      {path: '/Triton_entry', component: () => import('pages/Triton_entry.vue')},
      ...
      {path: '/Profile/:devId',name: 'PRO', component: () => import('pages/DeviceProfile.vue')},
      ...
      {path: '/Devices', component: () => import('pages/Device.vue')},
