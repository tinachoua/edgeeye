<template>
  <q-card class="table-bg">
    ...
    <q-card-section class="q-pa-none">
      <q-table  class="table-bg" :rows="data" :columns="columns" hide-bottom>
        <template v-slot:body-cell-Name="props">
          <q-td :props="props">
            <q-item style="max-width: 420px">
              ...
              <q-item-section @click=clickRow(props.row.name)>
...
const columns = [
  ...
  {name: 'Crated Date', label: 'Lasted online time', field: 'Crated_Date', sortable: true, align: 'left'},
  {name: 'Project', label: 'Module or GPU', field: 'Project', sortable: true, align: 'left'},
